...
MAINFILE="wemail.php" # for version checking
...
echo ".........................................."
echo
echo "Preparing to deploy weMail"
...
rsync -r --exclude='*.git*' --exclude="bin" --exclude="node_modules" --exclude="build" $SRC_DIR/* $TRUNK

...
class GutenbergBlock {
    ...
    public function register() {
        $blockMeta = require_once WEMAIL_PATH . '/assets/js/index.asset.php';

        wp_register_style('wemail-block-style', WEMAIL_ASSETS . '/css/gutenberg.css', [], WEMAIL_VERSION);
        wp_register_script('wemail-block-script', WEMAIL_ASSETS . '/js/index.js', $blockMeta['dependencies'], $blockMeta['version']);

        register_block_type('wemail/forms', [
